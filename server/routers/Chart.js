 ...
 * 对project里的chart的操作
 */
ChartRouter.get("/api/user/chartDetailInfo", (req, res) => {
...
ChartRouter.post("/api/user/chartDetailInfo", (req, res) => {
  let { body } = req;
...
ChartRouter.delete("/api/user/chartDetailInfo", (req, res) => {
...
ChartRouter.put("/api/user/chartDetailInfo", (req, res) => {
  let { body } = req;
