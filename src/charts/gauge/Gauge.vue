...
import GaugeTransform from "./gaugeTransform";
...
let option = GaugeTransform(props.optionsData, props.sourceData);
// const projectInfo = ProjectInfo();
watch([props.optionsData, props.sourceData], () => {
  // 侧边栏的变化回触发对应的customOption的变化， config变化后重新生成options
  option = GaugeTransform(props.optionsData, props.sourceData);
