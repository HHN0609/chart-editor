...
import BasicScatterTransform from "./basicscatterTransform";
...
let option = BasicScatterTransform(props.optionsData, props.sourceData);
// const projectInfo = ProjectInfo();
watch([props.optionsData, props.sourceData], () => {
  // 侧边栏的变化回触发对应的customOption的变化， config变化后重新生成options
  option = BasicScatterTransform(props.optionsData, props.sourceData);
